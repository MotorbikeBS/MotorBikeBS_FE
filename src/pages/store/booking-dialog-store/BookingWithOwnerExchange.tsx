...
// const BookingWithOwnerExchange: React.FC<BookingDialogProps> = ({
//     open,
//     motorbikeId,
//     openSubmit,
//     openCancel,
...
// export default BookingWithOwnerExchange

import React from 'react'

const BookingWithOwnerExchange = () => {
    return (
        <div>BookingWithOwnerExchange</div>
    )
}
