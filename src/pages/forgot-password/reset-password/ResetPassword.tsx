...
import { resetPassword, setError } from '../../../services/features/accountSlice';
...
const ResetPassword = () => {
    ...
    const onSubmit = async (data: FormValues) => {
        if (token) {
            try {
                await dispatch(resetPassword({ token, password: data.password, passwordConfirmed: data.passwordConfirmed }))
                // navigate('/login');
            } catch (err) {
                console.error(err);
            }
